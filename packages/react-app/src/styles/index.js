const styles = {
  // App.js
  container: "flex justify-center min-h-screen sm:px-16 px-6 bg-site-white",
  //container: "flex justify-center min-h-screen sm:px-16 px-6 white",
  innerContainer:
  ...
  headTitle: "#1d4ed8 font-poppins font-black text-5xl tracking-wide",
  ...
  exchangeBox: "relative md:max-w-[700px] md:min-w-[500px] min-w-full max-w-full p-[2px] rounded-3xl",
  exchange:
  ...
  // WalletButton
  walletButton:
    "bg-lime-600 border-none outline-none px-6 py-2 font-poppins font-bold text-lg text-white rounded-3xl leading-[24px] hover:bg-pink-600 transition-all",
